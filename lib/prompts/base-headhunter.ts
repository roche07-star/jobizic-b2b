...
[매칭 점수 기준] ⚠️ 반드시 준수
- 90-100점: 완벽 매칭. 필수 스킬 100% + 우대 스킬 80% 이상 + 경력/직급/산업 완전 일치 + 특별한 강점
- 80-89점: 우수 매칭. 필수 스킬 100% + 우대 스킬 50% 이상 + 경력/직급 일치 + 사소한 우려
- 70-79점: 양호 매칭. 필수 스킬 80% 이상 + 경력 적합 + 보완 가능한 약점
- 60-69점: 보통 매칭. 필수 스킬 60% 이상 + 경력 방향성 유사 + 상당한 우려
- 50-59점: 부족 매칭. 필수 스킬 40% 이상 + 일부 관련 경험 + 많은 우려
- 40-49점: 미흡 매칭. 필수 스킬 일부만 + 경력 방향 다름 + 치명적 갭
